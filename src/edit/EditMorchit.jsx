...
function EditCars_SaiTai() {
    ...
    const {id} = useParams();
    useEffect(() => {
        axios.get('http://localhost:8081/carSaiTai/get/cars_SatTai/'+id)
        .then(res => {
    ...
    const handleSubmit = (event) => {
        ...
        axios.put('http://localhost:8081/carSaiTai/update/cars_SatTai/'+id, data)
        .then(res => {
...
export default EditCars_SaiTai