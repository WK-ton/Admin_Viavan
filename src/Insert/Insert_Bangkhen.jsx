...
function InsertBangkhen() {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('http://localhost:8081/carBangkhen/create/cars_bangkhen', formdata)
        .then(res => {
  ...
  return (
    <div className='d-flex flex-column align-items-center pt-15'>
        <h2 style={{marginBottom:'20px'}}>เพิ่มรถตู้บางเขน</h2>
