...
function CarMonument() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8081/carMonument/getCars/cars_monument")
      .then((res) => {
  ...
  const handleDelete = (id) => {
    axios
      .delete('http://localhost:8081/carMonument/delete/cars_monument/' +id)
      .then((res) => {
        if (res.data.Status === "Success") {
